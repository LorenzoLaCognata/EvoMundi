...
public class EuropeanBeaver {
    ...
    public static final double FEMALE_LIFESPAN = 12.0;
    public static final double MALE_WEIGHT = 18.0;
    ...
    public static final double FEMALE_MATING_SEASON_END = 9.0;
    ...
    public static final double FEMALE_GESTATION_PERIOD = 9.0;
    public static final double MALE_AVERAGE_OFFSPRING = 0.0;
    public static final double FEMALE_AVERAGE_OFFSPRING = 2.0;
    public static final double MALE_JUVENILE_SURVIVAL_RATE = 0.0;
    public static final double FEMALE_JUVENILE_SURVIVAL_RATE = 0.45;
    public static final double MALE_MATING_SUCCESS_RATE = 0.0;
    public static final double FEMALE_MATING_SUCCESS_RATE = 0.75;
