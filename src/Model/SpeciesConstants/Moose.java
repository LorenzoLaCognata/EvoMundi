...
public class Moose {
    ...
    public static final double MATING_SEASON_END = 44.0;
    public static final double PREGNANCY_COOLDOWN = 42.0;
    public static final double GESTATION_PERIOD = 36.0;
    public static final double AVERAGE_OFFSPRING = 1.0;
    public static final double JUVENILE_SURVIVAL_RATE = 0.70;
    public static final double MATING_SUCCESS_RATE = 0.65;
